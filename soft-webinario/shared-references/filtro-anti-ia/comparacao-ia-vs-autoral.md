# Comparação IA vs Autoral

Exemplos lado a lado pra treinar a percepção.
...
- "completo, simples e eficiente" (tricolon)
- "transforma" (verbo IA)
- "trazendo clareza, resultados e liberdade" (tricolon + abstrações)
...
- Frase curta
- Sem auto-elogio
- Sem promessa redonda
- 80% menor que a versão IA
...
- "esses insights" (jargão de coach)
- "exatamente o que você precisa" (frase IA padrão)
...
- Sem performance de coach
- Sem promessa abstrata
- Curiosidade gerada pelo conteúdo, não pela frase
...
- "dê o salto definitivo" (cringe)
- 3 exclamações

### Versão autoral
> "Sua vaga: seusite.com.br/sua-vaga"
...
### Diagnóstico
- "Mais um dia incrível" (banido)
- "vou compartilhar com vocês" (vazio)
- "porque acredito que" (frase-emoldura)
- "bastidores é essencial" (jargão de creator)
- "conexão verdadeira" (adjetivo IA)
...
- "repensar nossas estratégias" (genérico)
...
- Sem promessa de prazo curto
- Diz o que ENTREGA, não o que PROMETE
- Filtra cliente certo no texto
...
### Diagnóstico
- "Olá! Que alegria ter você por aqui!" (cringe)
- "passo incrível na sua jornada" (jargão de coach)
- "não poderia estar mais animado" (cringe)
- "fazer parte dessa transformação" (cringe)
- "experiência única" (cringe)
- 4 exclamações em 4 frases

### Versão autoral
> "Você entrou. Vou te mandar 3 e-mails essa semana. Primeiro, contexto. Segundo, o método. Terceiro, próximos passos. Lê com calma. Sem pressa."

### Por que funciona
- Sem cringe de boas-vindas
- Diz o que vai acontecer
- Respeita o leitor (sem pressionar)
- Estabelece ritmo da relação
...
Versões IA têm em comum:
- Adjetivos decorativos
- Verbos de transformação genéricos
- Frases-emoldura
- Promessa abstrata
- Tricolons
- Cringe explícito

Versões autorais têm em comum:
- Fato concreto
- Frase curta
- Vocabulário oral
- Promessa específica ou ausência de promessa
- Ritmo variado
- Respeito ao leitor
...
Quando você sentir que sua copy "está parecendo IA mas não sei o quê":

1. Volta nesses 10 exemplos
2. Identifica qual padrão IA tá presente
3. Aplica a estratégia de reescrita
4. Compara com o equivalente autoral
...
Atualizar com mais exemplos quando:
