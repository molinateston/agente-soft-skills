...
- `shared-references/filtro-anti-ia/`, Stories é curto e vulnerável a frase-emoldura e tricolon de IA.
...
**Cliente com voz própria destilada (ex.: `soft-voz-[seu-nome]`):** consulta esta reference antes de escrever. O tom íntimo de Stories exige domínio total da voz autoral, qualquer deslize soa creator genérico.
